...
internal class AddOfferContractorMailFactory : MailFactoryBase<OfferModel>
{
    public AddOfferContractorMailFactory(IServiceProvider serviceProvider) : base(serviceProvider)
    {
    }
