...
internal class OfferAcceptedClientMailFactory : MailFactoryBase<OfferModel>
{
    public OfferAcceptedClientMailFactory(IServiceProvider serviceProvider) : base(serviceProvider)
    {
    }
